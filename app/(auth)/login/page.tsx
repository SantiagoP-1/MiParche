  ...
  return (
    <div className="w-full max-w-md animate-fade-up">
      ...
      <div className="text-center mb-10">
        ...
        <h1 className="font-serif text-3xl font-light mt-4 mb-2">Bienvenida de vuelta</h1>
        <p className="font-serif text-text-muted text-sm font-light">Ingresá a tu cuenta para continuar</p>
      </div>
      ...
      <div className="bg-surface border border-border rounded-2xl p-8">
        ...
        {/* Social buttons (routed through Auth0) */}
